...
for(let i=0; i<apps.length; i++){
	...
	commands.push('cp ' + escapp_library_path + '/dist/escapp.js ' + app_path + '/public/vendors/escapp.js');
	commands.push('cp ' + escapp_library_path + '/dist/escapp.css ' + app_path  + '/public/vendors/css/escapp.css');
	commands.push('cp ' + escapp_library_path + '/dist/images/* ' + app_path  + '/public/vendors/images');
}
